---
title: 'Distributed Tracing Zipkin + Kafka + Docker + Spring Boot: Tracing - Hành trình trở thành Sherlock Dev'
abstract: 'Distributed Tracing Zipkin + Kafka + Docker + Spring Boot: Tracing - Hành trình trở thành Sherlock Dev.'
date: '2023-12-03'
